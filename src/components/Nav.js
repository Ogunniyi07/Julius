...
const Nav = () => {
  ...
  return (
    <div className="fixed z-20">
      <nav className="w-full bg-[#000] flex fixed items-center justify-between pt-5 pl-10 pr-[80px]">
        <Link to="/">
          <img
            src="./images/logo.png"
            alt="logo"
            className="w-[50px] ml-[50px] md:ml-[-20px]"
          />
        </Link>
        <img
        ...
        />
        <ul
          className={`bg-[#ffffff14] backdrop-blur-lg pr-[50px] lg:pr-[150px] md:pl-[50px] static md:fixed top-16 h-auto md:h-screen duration-500 ease-linear md:overflow-scroll ${
